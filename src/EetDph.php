...
class EetDph
{
	 ...
	 */
	function setZaklNepodlDph(float $zaklNepodlDph)
	{
	 ...
	 */
	function setZaklDan1(float $zaklDan1)
	{
	 ...
	 */
	function setZaklDan2(float $zaklDan2)
	{
	 ...
	 */
	function setZaklDan3(float $zaklDan3)
	{
	 ...
	 */
	function setCestSluz(float $cestSluz)
	{
	 ...
	 */
	function setPouzitZboz1(float $pouzitZboz1)
	{
	 ...
	 */
	function setPouzitZboz2(float $pouzitZboz2)
	{
	 ...
	 */
	function setPouzitZboz3(float $pouzitZboz3)
	{
	 ...
	 */
	function setUrcenoCerpZuct(float $urcenoCerpZuct)
	{
	 ...
	 */
	function setCerpZuct(float $cerpZuct)
	{
